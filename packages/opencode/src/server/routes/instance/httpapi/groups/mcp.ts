...
export class McpSafeStartDisabledError extends Schema.ErrorClass<McpSafeStartDisabledError>(
  "McpSafeStartDisabledError",
)({ error: Schema.String }, { httpApiStatus: 409 }) {}
    ...
    HttpApiGroup.make("mcp")
      .add(
        ...
        HttpApiEndpoint.post("add", McpPaths.status, {
          ...
          error: [HttpApiError.BadRequest, McpSafeStartDisabledError],
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "mcp.add",
        ...
        HttpApiEndpoint.post("authStart", McpPaths.auth, {
          ...
          error: [UnsupportedOAuthError, McpServerNotFoundError, McpSafeStartDisabledError],
        }).annotateMerge(
          OpenApi.annotations({
        ...
        HttpApiEndpoint.post("authCallback", McpPaths.authCallback, {
          ...
          error: [HttpApiError.BadRequest, McpServerNotFoundError, McpSafeStartDisabledError],
        }).annotateMerge(
          OpenApi.annotations({
        ...
        HttpApiEndpoint.delete("authRemove", McpPaths.auth, {
          ...
          error: [McpServerNotFoundError, McpSafeStartDisabledError],
        }).annotateMerge(
          OpenApi.annotations({
