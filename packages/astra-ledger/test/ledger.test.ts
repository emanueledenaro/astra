...
describe("snapshot-consistent ledger reads under a concurrent committed writer", () => {
  test("keeps paired read statements on one snapshot instead of reporting spurious corruption", async () => {
