...
import type {
  ProjectParentAuthorityBlockReason,
  ProjectParentAuthorityCaptureResult,
  ProjectParentAuthorityRevalidationResult,
} from "./project-parent-authority"

export type ProjectParentAuthorityFilesystem = Readonly<{
  lstat(path: string): Promise<Stats>
  realpath(path: string): Promise<string>
}>

export async function captureProjectParentAuthorityInternal(
  parentPath: string,
  targetName: string,
  observedAt: string,
...
export async function revalidateProjectParentAuthorityInternal(
  input: unknown,
  filesystem: ProjectParentAuthorityFilesystem,
