...
export const Definitions = {
  ...
  astra_control_toggle: keybind("<leader>i", "Toggle Astra control rail"),
  astra_review_toggle: keybind("<leader>r", "Open Astra candidate review"),
...
export const CommandMap = {
  ...
  astra_control_toggle: "astra.control.toggle",
  astra_review_toggle: "astra.review.toggle",
  help_show: "help.show",
  docs_open: "docs.open",
  diff_open: "diff.open",
